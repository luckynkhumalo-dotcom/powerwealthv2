export const COUNTRIES = [
  ...
  { name: 'Aland Islands', iso: 'AX', code: '+358', flag: '🇦🇽' },
  { name: 'Albania', iso: 'AL', code: '+355', flag: '🇦🇱' },
  { name: 'Algeria', iso: 'DZ', code: '+213', flag: '🇩🇿' },
  { name: 'American Samoa', iso: 'AS', code: '+1', flag: '🇦🇸' },
  { name: 'Andorra', iso: 'AD', code: '+376', flag: '🇦🇩' },
  { name: 'Angola', iso: 'AO', code: '+244', flag: '🇦🇴' },
  { name: 'Anguilla', iso: 'AI', code: '+1', flag: '🇦🇮' },
  { name: 'Antigua and Barbuda', iso: 'AG', code: '+1', flag: '🇦🇬' },
  ...
  { name: 'Bermuda', iso: 'BM', code: '+1', flag: '🇧🇲' },
  ...
  { name: 'Brunei Darussalam', iso: 'BN', code: '+673', flag: '🇧🇳' },
  ...
  { name: 'Cayman Islands', iso: 'KY', code: '+1', flag: '🇰🇾' },
  ...
  { name: 'Congo, Democratic Republic of the', iso: 'CD', code: '+243', flag: '🇨🇩' },
  { name: 'Cook Islands', iso: 'CK', code: '+682', flag: '🇨🇰' },
  { name: 'Costa Rica', iso: 'CR', code: '+506', flag: '🇨🇷' },
  { name: 'Cote d\'Ivoire', iso: 'CI', code: '+225', flag: '🇨🇮' },
  ...
  { name: 'Falkland Islands (Malvinas)', iso: 'FK', code: '+500', flag: '🇫🇰' },
  ...
  { name: 'Holy See (Vatican City State)', iso: 'VA', code: '+379', flag: '🇻🇦' },
  ...
  { name: 'Iran, Islamic Republic of', iso: 'IR', code: '+98', flag: '🇮🇷' },
  ...
  { name: 'Korea, Democratic People\'s Republic of', iso: 'KP', code: '+850', flag: '🇰🇵' },
  { name: 'Korea, Republic of', iso: 'KR', code: '+82', flag: '🇰🇷' },
  { name: 'Kuwait', iso: 'KW', code: '+965', flag: '🇰🇼' },
  { name: 'Kyrgyzstan', iso: 'KG', code: '+996', flag: '🇰🇬' },
  { name: 'Lao People\'s Democratic Republic', iso: 'LA', code: '+856', flag: '🇱🇦' },
  ...
  { name: 'Libyan Arab Jamahiriya', iso: 'LY', code: '+218', flag: '🇱🇾' },
  ...
  { name: 'Macedonia, The Former Yugoslav Republic of', iso: 'MK', code: '+389', flag: '🇲🇰' },
  ...
  { name: 'Micronesia, Federated States of', iso: 'FM', code: '+691', flag: '🇫🇲' },
  { name: 'Moldova, Republic of', iso: 'MD', code: '+373', flag: '🇲🇩' },
  { name: 'Monaco', iso: 'MC', code: '+377', flag: '🇲🇨' },
  { name: 'Mongolia', iso: 'MN', code: '+976', flag: '🇲🇳' },
  { name: 'Montenegro', iso: 'ME', code: '+382', flag: '🇲🇪' },
  { name: 'Montserrat', iso: 'MS', code: '+1', flag: '🇲🇸' },
  ...
  { name: 'Northern Mariana Islands', iso: 'MP', code: '+1', flag: '🇲🇵' },
  ...
  { name: 'Palestinian Territory, Occupied', iso: 'PS', code: '+970', flag: '🇵🇸' },
  ...
  { name: 'Pitcairn', iso: 'PN', code: '+64', flag: '🇵🇳' },
  ...
  { name: 'Reunion', iso: 'RE', code: '+262', flag: '🇷🇪' },
  { name: 'Romania', iso: 'RO', code: '+40', flag: '🇷🇴' },
  { name: 'Russian Federation', iso: 'RU', code: '+7', flag: '🇷🇺' },
  { name: 'Rwanda', iso: 'RW', code: '+250', flag: '🇷🇼' },
  { name: 'Saint Barthelemy', iso: 'BL', code: '+590', flag: '🇧🇱' },
  ...
  { name: 'Sint Maarten', iso: 'SX', code: '+1', flag: '🇸🇽' },
  ...
  { name: 'Swaziland', iso: 'SZ', code: '+268', flag: '🇸🇿' },
  { name: 'Sweden', iso: 'SE', code: '+46', flag: '🇸🇪' },
  { name: 'Switzerland', iso: 'CH', code: '+41', flag: '🇨🇭' },
  { name: 'Syrian Arab Republic', iso: 'SY', code: '+963', flag: '🇸🇾' },
  { name: 'Taiwan, Province of China', iso: 'TW', code: '+886', flag: '🇹🇼' },
  { name: 'Tajikistan', iso: 'TJ', code: '+992', flag: '🇹🇯' },
  { name: 'Tanzania, United Republic of', iso: 'TZ', code: '+255', flag: '🇹🇿' },
  ...
  { name: 'Turks and Caicos Islands', iso: 'TC', code: '+1', flag: '🇹🇨' },
  ...
  { name: 'Viet Nam', iso: 'VN', code: '+84', flag: '🇻🇳' },
  { name: 'Virgin Islands, British', iso: 'VG', code: '+1', flag: '🇻🇬' },
  { name: 'Virgin Islands, U.S.', iso: 'VI', code: '+1', flag: '🇻🇮' },
